...
def main():
    ...
    #     )
    config = ChatGLMConfig.from_json_file('./chatglm_config/config_130b.json')
    print(config)
    # print(args.model_name_or_path + '/config.json')
    tokenizer = ChatGLMTokenizer.from_pretrained('./chatglm_config')
    ...
    dp_pg_size = dist.get_world_size(dp_pg)
    dp_pg_rank = dist.get_rank(dp_pg)
