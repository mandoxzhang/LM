...
def main():
    ...
    logger.info(f'init has cost {(time.time() - start) / 60:.3f} mins')
    ...
    logger.info(f'tp init has cost {(time.time() - start) / 60:.3f} mins')
    ...
    logger.info(f'geminiddp has cost {(time.time() - start) / 60} mins')
